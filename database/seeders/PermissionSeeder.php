...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //Product Transfer
        $resourece_features['product-transfer'] = ['l', 'c', 'u', 'd'];
        //
        $resourece_features['delivery-agent'] = ['l', 'c', 'u', 'd'];

        // Pos
        $resourece_features['pos'] = ['l', 'c', 'r', 'u', 'd'];
        $other_permissions['pos-online-sale']='pos';
        ...
        $other_permissions['pos_return']='pos';
        $other_permissions['pos_return_list']='pos';
        $other_permissions['pos-profit']='pos';
        $other_permissions['pos-purchase_cost']='pos';
        $other_permissions['purchase_cost_breakdown']='pos';
        ...
        //Shop
        $resourece_features['shop'] = ['l', 'c', 'u', 'd'];
        // Payments
        ...
        //Area
        $resourece_features['area'] = ['l', 'c', 'u', 'd'];
        ...
        $other_permissions['seller_report']='report';
        ...
        $other_permissions['all_shop_report']='report';
