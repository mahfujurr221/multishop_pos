...
<aside class="sidebar sidebar-expand-lg sidebar-dark">
    ...
    <nav class="sidebar-navigation">
        <ul class="menu">
            ...
            @can('list-shop')
            <li class="menu-item {{ Request::routeIs('shops.index') ? 'active' : '' }}">
                <a class="menu-link" href="{{ route('shops.index') }}">
                    <img src="{{ asset('dashboard/sidebar_icons/shop.svg') }}" alt=""
            ...
            @can('all_shop_report')
                <li class="menu-item {{ Request::routeIs('all_daily_report') ? 'active' : '' }}">
                    <a class="menu-link" href="{{ route('all_daily_report') }}">
                        <img src="{{ asset('dashboard/sidebar_icons/money_report.svg') }}" alt=""
                            class="sidebar_icon icon">
                        <span class="title">All Shop Report</span>
                    </a>
                </li>
            @endcan
            @can('list-owner')
            ...
            @canany(['list-pos', 'create-pos', 'list-purchase', 'create-purchase','pos_return'])
            <li class="menu-category">Sale & Purchase</li>
                ...
                @endcan
                @can('pos-online-sale')
                <li class="menu-item {{ Request::routeIs('sales.online') ? 'active' : '' }}">
                <a class="menu-link" href="{{ route('sales.online') }}">
                    <span class="icon fa fa-shopping-bag"></span>
                ...
                @canany(['list-product-transfer', 'create-product-transfer'])
                <li class="menu-item {{ Request::routeIs('product-transfer.*')||Request::routeIs('transfer_received') ? 'active open' : '' }}">
                    <a class="menu-link" href="#">
                    ...
                    <ul class="menu-submenu">
                        @can('create-product-transfer')
                        <li class="menu-item {{ Request::routeIs('product-transfer.create') ? 'active' : '' }}">
                            <a class="menu-link" href="{{ route('product-transfer.create') }}">
                                <span class="dot"></span>
                                <span class="title">Add Product Transfer</span>
                            </a>
                        </li>
                        @endcan
                   
                        @can('list-product-transfer')
                        <li class="menu-item {{ Request::routeIs('product-transfer.index') ? 'active' : '' }}">
                            <a class="menu-link" href="{{ route('product-transfer.index') }}">
                                <span class="dot"></span>
                                <span class="title">Product Transfers</span>
                            </a>
                        </li>
                        @endcan
                        <li class="menu-item {{ Request::routeIs('transfer_received') ? 'active' : '' }}">
                            <a class="menu-link" href="{{ route('transfer_received') }}">
                                <span class="dot"></span>
                                <span class="title">Transfer Received</span>
                            @if ($tarnsfer_order->where('shop_id',session('shop'))->where('status', 0)->count() > 0)
                            <span class="badge badge-danger">
                                {{ $tarnsfer_order->where('shop_id',session('shop'))->where('status', 0)->count() }}
                            </span>
                            @endif
                            </a>
                        </li>
            ...
            @canany(['list-expense', 'create-expense', 'list-payment', 'create-payment', 'list-expense_category'])
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-submenu">
                        @can('create-payment')
                        <li class="menu-item {{ Request::routeIs('payment.supplier.create') ? 'active' : '' }}">
            ...
            @canany(['list-customer', 'create-customer', 'list-supplier', 'create-supplier'])
                ...
                <li class="menu-item {{ Request::routeIs('supplier.*') ? 'active open' : '' }}">
                    ...
                    @canany(['list-delivery-agent', 'create-delivery-agent'])
                    <li class="menu-item {{ Request::routeIs('delivery-agent.*') ? 'active open' : '' }}">
                    <a class="menu-link" href="#">
                        <span class="icon fa fa-users"></span>
                        <span class="title">Delivery Agents</span>
                        <span class="arrow"></span>
                    </a>

                        <ul class="menu-submenu">
                            @can('list-delivery-agent')
                            <li class="menu-item {{ Request::routeIs('delivery-agent.create') ? 'active' : '' }}">
                                <a class="menu-link" href="{{ route('delivery-agent.create') }}">
                                    <span class="dot"></span>
                            ...
                            @endcan
                            @can('list-delivery-agent')
                            <li class="menu-item {{ Request::routeIs('delivery-agent.index') ? 'active' : '' }}">
                                <a class="menu-link" href="{{ route('delivery-agent.index') }}">
                                    <span class="dot"></span>
                ...
                @endcan
                @can('seller_report')
                <li class="menu-item {{ Request::routeIs('report.seller_report') ? 'active' : '' }}">
                    <a class="menu-link" href="{{ route('report.seller_report') }}">
            ...
            @canany(['setting', 'backup', 'list-role', 'list-user'])
                <li class="menu-category">Setting & Customize</li>
                 @can('list-area')
                <li class="menu-item {{ Request::routeIs('area.index') ? 'active' : '' }}">
