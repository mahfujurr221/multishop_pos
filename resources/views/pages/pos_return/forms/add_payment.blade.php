<form action="{{ route("return.add_payment",$return->id) }}" id="edit_form" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input type="text" name="pay_amount" value="{{ $return->due() }}" class="form-control">
    </div>
