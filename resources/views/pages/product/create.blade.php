        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-4">
            ...
            <div class="form-group sizes">
              ...
              {{-- <hr> --}}
              <a href="" class="btn btn-primary add_input" style=""><i class="fa fa-plus"> Add Size</i></a>

              <div class="form-group colors mt-3">
              ...
              <a href="" class="btn btn-primary add_color_input" style=""><i class="fa fa-plus"> Add Color</i></a>
          </div>
        </div>
        <hr>
