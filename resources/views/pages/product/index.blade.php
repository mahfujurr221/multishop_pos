              ...
              <td class="text-center">
                ...
                <div class="btn-group">
                  ...
                  <div class="dropdown-menu" x-placement="bottom-start">
                    ...
                    <a class="dropdown-item" href="{{ route('product.sell_history',$product->id) }}">
                      <i class="fa fa-history"></i>
                      Sell History
                    </a>

                    <a class="dropdown-item delete" href="{{ route('product.destroy', $product->id) }}">
                ...
                <button class="btn btn-light btn-sm generated_barcode"
                    data-name="{{ $product->category->name }}" data-code="{{ $product->code }}" data-price="{{ $product->price }}">
                    <i class="fa fa-barcode"></i>
                </button>

                <button class="btn btn-light btn-sm" data-toggle="modal" data-target="#qr_code_{{ $product->id }}"><i
...
<style>
  ...
  @media print {
    ...
    .header h1, .header a, h1, h2, h3, h4, h5, h6, p, .product, .shopping-cart p, footer p, .select2-container--default .select2-selection--single .select2-selection__rendered, strong, span {
