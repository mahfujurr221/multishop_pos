  ...
  <script>
      $(document).on('click', '.generated_barcode', function() {
            ...
            $.get(url, (data) => {
                ...
                let barcode = '';
                barcode += `
                    <div class="text-center p-4" id="barcode" style="padding:0 !important">
                        <table class="table" style="margin-bottom:0 !important;">
                            <tr>
                                <td style="border-top:0 !important;padding:0;" class="code_p">
                                <p style="margin-bottom:10px; line-height:9px; margin-top:10px; font-size: 15px; color:black;"><strong>${company}</strong></p>
                                ${data}
                                {{--<p style="margin-bottom:5px; line-height:9px; margin-top:5px; font-size: 15px;"><strong>${code}</strong></p>--}}
                                <p style="margin-bottom:0; line-height:9px; margin-top:0px; font-size: 15px; color:black;"><strong>${name}</strong></p>

                                <p style="margin-bottom:0; line-height:9px; margin-top:10px; font-size: 15px; color:black;"><strong>Price: ${price} Tk</strong></p>
                                </td>
                            </tr>
                        </table>
                    </div>`;
