    ...
    <div class="row justify-content-center">
        <div class="col-md-7 card card-body print">
            <div id="print-area">
                ...
                <div class="cus_info">
                    Delivery Agent : <span>{{ $pos->delivery_agent ? $pos->delivery_agent->name : '-'}}</span>
                </div>
                ...
                <table class="table table-bordered table-plist my-3 order-details">
                    ...
                    <tr>
                        <td>{{ ++$key }}</td>
                        <td>{{ $item->product_name }} @if($item->variation) || Size:  {{$item->variation->name}}@endif</td>
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td>
                            <strong>{{ number_format($pos->delivery_charge,2) }} </strong>Tk
                        </td>
                    </tr>
...
<style rel="stylesheet">
    ...
    .note,.in_word,.signature,.bill-no,.cus_info,.date,.name,.mobile-no,.address,th,td,address,h4{
          color:black;
     }
