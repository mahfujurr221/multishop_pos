        ...
        <div class="col-md-7 card card-body print">
            <div id="print-area">
                ...
                <table class="table table-bordered table-plist my-3 order-details">
                    ...
                    <tr>
                        <td>{{ ++$key }}</td>
                        <td>{{ $item->product_name." - Code : ".$item->product->code }}</td>
                        <td>@if($item->variation){{$item->variation->name}}@endif</td>
                    ...
                    @endphp
                    <tr>
                        <td colspan="5" class="rm-b-l rm-b-t rm-b-b"></td>
...
<style rel="stylesheet">
    ...
    .logo-area img {
        @if($pos_setting->invoice_logo_type=="Both") width: 18%;
        @else width: 18%;
