<script>
    ...
    function getPurchaseItemId(purchaseId) {
        let url = "{{ route('purchase.item_product_id', 'pid') }}".replace('pid', purchaseId);
        ...
        $("#product_search").autocomplete({
            ...
            select: function(event, ui) {
                ...
                $.get(url, (product) => {
                    ...
                    <input type="number" value="1" class="form-control col main_qty" name="new_main_qty[]"  onkeydown="return event.keyCode !== 190" min="1">
                    <input type="number" value="" class="form-control col sub_qty" name="new_sub_qty[]"  onkeydown="return event.keyCode !== 190" hidden>
                    `;
                    } else {
                        quantity_data =
                    ...
                    <input type="number" value="1" class="form-control col main_qty mr-4" name="new_main_qty[]"  onkeydown="return event.keyCode !== 190" min="1">
              ...
              <tr>
                ...
                <input type="hidden" value="${product.id}" name="new_product[]" class="product">
                </td>
                <td style="width:100px">
                    ${variation_data}
                </td>
                <td style="width:150px">
                  <input type="text" value="${product.cost}" class="form-control rate" name="new_rate[]">
                </td>
                <td class="pr-3">
                    <div class="form-row">
                        ${quantity_data}
    ...
    // change qty
    $(document).on('keyup', '.main_qty', function() {
