<form action="{{ route("purchase.add_payment",$purchase) }}" id="edit_form" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input type="text" name="pay_amount" value="{{ $purchase->due }}" class="form-control">
    </div>
