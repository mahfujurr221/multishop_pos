<form action="{{ route("supplier.wallet_payment",$supplier) }}" id="edit_form" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input type="text" name="pay_amount" value="{{ $supplier->due() }}" class="form-control">
    </div>
