...
<header class="header bg-ui-general">
  ...
  <div class="header-action">
    <nav class="nav">
      <a class="nav-link active" href="{{ route('shops.index') }}">
        Shops
      </a>
...
<div class="col-12">
  ...
  <div class="card">
    <h4 class="card-title"><strong>Shops</strong></h4>
        ...
        <table class="table table-sm table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $item->name }}</td>
              <td><img src="{{ asset($item->logo) }}" alt="" style="max-height:100px;max-width:150px;"></td>
              <td>{{ $item->email }}</td>
              <td>{{ $item->phone }}</td>
              <td>{{ $item->address }}</td>
              ...
              <td class="text-center">
                ...
                <div class="btn-group">
                  ...
                  <div class="dropdown-menu" x-placement="bottom-start">
                    ...
                    <a class="dropdown-item" href="{{ route('shops.edit', $item->id) }}">
                    ...
                    <a class="dropdown-item delete" href="{{ route('shops.destroy', $item->id) }}">
