...
class StockService{
    public static function return_purchase_ids_and_qty_for_the_sell($product_id,$product_variation_id, $qty,$shop_id=null)
    {
        // dd("HE");
        ...
        if($shop_id){
            $purchase_items = PurchaseItem::withoutGlobalScopes()
    ...
    public static function add_new_pos_items_and_recalculate_cost($request, $pos)
    {
        ...
        if ($request->product_id) {
            ...
            foreach ($request->product_id as $key => $value) {
                ...
                $purchase_distribution = StockService::return_purchase_ids_and_qty_for_the_sell($request->product_id[$key],$variation, $qty);
            ...
            if ($pos_item->qty != $qty) {
                ...
                if ($qty > $pos_item->qty) {
                    ...
                    if ($stock_quantity == $qty) {
                        ...
                        $purchase_distribution = StockService::return_purchase_ids_and_qty_for_the_sell($pos_item->product_id,$pos_item->product_variation_id, $new_quantity);
                        // dd($purchase_distribution);
