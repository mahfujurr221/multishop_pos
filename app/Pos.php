...
class Pos extends Model
{
    ...
    public function profit()
    {
        ...
        if ($this->returns->count() == 0) {
            ...
            return [
                ...
                'profit' => $this->receivable - $this->total_purchase_cost - $this->delivery_charge
            ];
        } else {
            // dd("HAS RETURNS");
            $total_sell_value = 0;
            ...
            return [
                ...
                'profit' => $discounted_sell_value - $total_purchase_cost - $this->delivery_charge
            ];
    ...
    public function filter($request, $sales)
    {
        ...
        if ($request->delivery_man) {
            $sales = $sales->where('delivery_agent_id', $request->delivery_man);
        }
